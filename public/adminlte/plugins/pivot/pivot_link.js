      ...
      for (i in rowKeys) {
        ...
        for (j in colKeys) {
          ...
          var cadena=colKey+'';
                    ...
                    var cadena1=colAttrs+'';

                    var arrayDeCadenas1 = cadena1.split(",");
                    var arrayFinal1=[];
                    for (var j=0; j < arrayDeCadenas1.length; j++) {
                        arrayFinal1.push(String("'"+arrayDeCadenas1[j]+"'"));
                    }
          ...
          a.setAttribute("onclick", "EditChangesIntern("+arrayFinal+","+arrayFinal1+")");
          a.textContent = aggregator.format(val);
          td.appendChild(a);
        ...
        td.className = "pvtTotal rowTotal";
          ...
          a = document.createElement("a");
			...
			a.textContent=totalAggregator.format(val);
		td.appendChild(a);
        td.setAttribute("data-value", val);
        if (getClickHandler != null) {
