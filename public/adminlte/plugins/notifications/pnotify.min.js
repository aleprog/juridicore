...
(function (d, e) {
        ...
        sticker: null, init: function (a, b) {
            ...
            this.sticker = d("<div />", {
                ...
                var b = null === c.options.classes.pin_up ? a.styles.pin_up :
                    c.options.classes.pin_up, e = null === c.options.classes.pin_down ? a.styles.pin_down : c.options.classes.pin_down;
                d(this).children().attr("class", "").addClass(a.options.hide ? b : e).attr("aria-pressed", a.options.hide ? "false" : "true")
    ...
    d.extend(e.styling.brighttheme, {
        closer: "fa fa-times",
        pin_up: "fa fa-dot-circle",
        pin_down: "fa fa-circle"
    });
...
(function (e, c) {
    ...
    c.prototype.modules.confirm = {
        container: null, prompt: null, init: function (b, a) {
            ...
            for (var m = a.buttons[0] && a.buttons[0] !== c.prototype.options.confirm.buttons[0], f = 0; f < a.buttons.length; f++)if (!(null ===
                ...
                a.prompt && !a.prompt_multi_line && g.promptTrigger && this.prompt.keypress(function (b) {
                    return function (a) {
...
(function (e, c) {
    ...
    c.prototype.options.desktop = {desktop: !1, fallback: !0, icon: null, tag: null};
    c.prototype.modules.desktop = {
        tag: null, icon: null, genNotice: function (a, b) {
            ...
            //a.desktop = f(a.options.title, {icon: this.icon, body: b.text || a.options.text, tag: this.tag});
...
(function (b, a) {
    ...
    b(function () {
        b("body").on("pnotify.history-all", function () {
            ...
            function () {
                var b = "top" === a.prototype.options.stack.push, d = b ? 0 : -1, c;
                do {
    ...
    a.prototype.modules.history = {
        inHistory: !1, init: function (a, d) {
            ...
            d.menu && "undefined" === typeof c && (c = b("<div />", {
                ...
                "class": "ui-pnotify-history-all " + a.styles.hi_btn, text: d.labels.all, mouseenter: function () {
    ...
    b.extend(a.styling.bootstrap2, {hi_menu: "well", hi_btn: "btn", hi_btnhov: "", hi_hnd: "icon-chevron-down"});
    ...
    c.prototype.modules.mobile = {
        swipe_dismiss: !0, init: function (a, b) {
            ...
            if (b.styling)if (a.elem.addClass("ui-pnotify-mobile-able"), 480 >= g(window).width())a.options.stack.mobileOrigSpacing1 || (a.options.stack.mobileOrigSpacing1 = a.options.stack.spacing1, a.options.stack.mobileOrigSpacing2 = a.options.stack.spacing2),
                a.options.stack.spacing1 = 0, a.options.stack.spacing2 = 0; else {
