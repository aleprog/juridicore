...
@section('javascript')
    <script src="{{ url('js/modules/solicitudes/seguimiento.js') }}"></script>
...
@section('content')
    ...
    <div class="col-lg-2" style="float:left;margin:5px">
        {!! Form::select('bandejaSeguimiento',$bandejaSeguimiento, 0,['class' => 'form-control select2',"style"=>"width:100%","id"=>"bandejaSeguimiento"]) !!}
                                                                            ...
                                                                            <div class="container-fluid">
                                                                                ...
                                                                                <div class="col-lg-12 form-group">
                                                                                    ...
                                                                                    <div class="col-lg-3">
                                                                                        ...
                                                                                        {!! Form::text('celular_entrega', null,["required"=>"required","class"=>"form-control" ,"placeholder"=>"Celular","name"=>"celular_entrega",'maxlength'=>'10','onKeypress'=>'if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;']) !!}
                                                                                    </div>
                                                                                    <div class="col-lg-3">
