...
<div class="row">
        ...
        <div class="panel-body" style="margin:25px">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('persona_id', old('persona_id'), ['class' => 'form-control', 'placeholder' => '', 'required' => '','maxlength'=>'13']) !!}
    ...
    {!! Form::submit(trans('global.app_update'), ['class' => 'btn btn-lg btn-primary']) !!}
    {!! Form::close() !!}
@stop
