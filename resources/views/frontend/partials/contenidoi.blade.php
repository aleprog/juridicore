					...
					<form method="POST" action="{{ route ('storage.create')}}" accept-charset="UTF-8" enctype="multipart/form-data">
							...
							<div class="form-group">
							  <label class="col-md-2 control-label" for="Escuela">Escuela</label>  
								...
								{!! Form::select('carrera', ['Derecho'=>'Derecho','Sociologia'=>'Sociologia'], $datos['data']["carrera"],['class' => 'form-control select2','placeholder'=>'Carrera',"style"=>"width:100%","id"=>"carrera","name"=>"carrera"]) !!}
								</div>
								<label class="col-md-2 control-label" for="modalidad">Modalidad</label>  
								<div class="col-md-4">

								{!! Form::select('modalidad', ['SEMESTRAL'=>'SEMESTRAL','ANUAL'=>'ANUAL','MODULAR'=>'MODULAR'], $datos['data']["modalidad"],['class' => 'form-control select2','placeholder'=>'Modalidad',"style"=>"width:100%","id"=>"modalidad","name"=>"modalidad"]) !!}
								</div>
								<br/>
								<hr/>
							</div>
							<div class="form-group">
							  ...
							  <label class="col-md-2 control-label" for="Escuela">Nivel</label>  
								{!! Form::select('nivel', ['7'=>'7','8'=>'8','9'=>'9','EGRESADO'=>'EGRESADO'], $datos['data']["semestre"],['class' => 'form-control select2','placeholder'=>'nivel',"style"=>"width:100%","id"=>"nivel","name"=>"nivel"]) !!}
								</div>
								<div class="col-md-4">
							...
							<div class="form-group">
							 <div class="col-md-4">
								...
								{!! Form::select('estado_civil', ['SOLTERO'=>'SOLTERO','CASADO'=>'CASADO','VIUDO'=>'VIUDO','DIVORCIADO'=>'DIVORCIADO','UNION LIBRE'=>'UNION LIBRE'],  $datos['data']["estado_civil"],['class' => 'form-control select2','placeholder'=>'Estado civil',"style"=>"width:100%","id"=>"estado_civil","name"=>"estado_civil"]) !!}
							  </div>
							  <div class="col-md-4">
							...
							<div class="form-group">
							 <div class="col-md-4">
							  ...
							  <div class="col-md-4">
								...
								{!! Form::text('celular', $datos['data']["celular"],['class' => 'form-control', "maxlength"=>"10",'placeholder'=>'telefono laboral',"style"=>"width:100%","onKeypress"=>"return soloNumeros(event)","id"=>"celular","name"=>"celular"]) !!}
							...
							<div class="form-group">
							 <div class="col-md-4">
								...
								{!! Form::select('labora', ['SI'=>'SI','NO'=>'NO'], $datos['data']["labora"],['class' => 'form-control select2',"style"=>"width:100%","id"=>"labora","name"=>"labora"]) !!}
							  </div>
							  <div class="col-md-4">
							...
							<div class="form-group">
							 <div class="col-md-4">
								...
								{!! Form::select('discapacidad', ['SI'=>'SI','NO'=>'NO'], $datos['data']["discapacidad"],['class' => 'form-control select2',"style"=>"width:100%","id"=>"discapacidad","name"=>"discapacidad"]) !!}
							  </div>
							  <div class="col-md-4">
